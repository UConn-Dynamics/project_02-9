...
begin
	 figure_p1_x = plot!(
		 ...
		 linewidth = 2,
		 title = "Piston 1  X Direction Kinematics Plot"
	 )
	...
	figure_p1_y =  plot(
		 ...
		 label = ["Position" "Velocity" "Acceleration"],
		 linewidth = 2,
		 title = "Piston 1 Y Direction Kinematics Plot"
	 )
	plot(figure_p1_x,figure_p1_y)
end
...
begin
	...
	channel2_direction = (cos(α2 + π/2), sin(α2 + π/2))  # crossed channels
end
